...
void ATautRopeSimulatorCPU::Integrate(int32 ParticleIdx, float SubStepDeltaSeconds)
{
...
void ATautRopeSimulatorCPU::SolvePositionConstraint(int32 InFrameExeCount)
{
	for (int32 ParticleIdx = 0; ParticleIdx < NumParticles; ++ParticleIdx)
	{
...
void ATautRopeSimulatorCPU::SolveStaticFriction(float SubStepDeltaSeconds, int32 SubStepCount)
{
...
void ATautRopeSimulatorCPU::SolveVelocity(float DeltaSeconds, float SubStepDeltaSeconds, int32 SubStepCount)
{
...
void ATautRopeSimulatorCPU::ApplyDistanceConstraint(int32 ParticleIdx)
{
...
void ATautRopeSimulatorCPU::ApplyRopeBlockersCollisionConstraint(int32 ParticleIdx, int32 InFrameExeCount)
{
...
void ATautRopeSimulatorCPU::ApplyWallCollisionConstraint(int32 ParticleIdx)
{
	const FVector& RopeCenter = Positions[ParticleIdx];
...
void ATautRopeSimulatorCPU::ApplyRopeBlockersVelocityConstraint(int32 ParticleIdx, float DeltaSeconds, float SubStepDeltaSeconds, int32 SubStepCount)
{
...
namespace NiagaraSandbox::TautRopeSimulator
{
...
void ATautRopeSimulatorCPU::ApplyWallVelocityConstraint(int32 ParticleIdx, float SubStepDeltaSeconds)
{
	using namespace NiagaraSandbox::TautRopeSimulator;
